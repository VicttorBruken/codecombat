...
#    mission_description_2: "As it turns out, that enables them to learn faster too. WAY faster. It's like having a conversation instead of reading a manual. We want to bring that conversation to every school and to <strong>every student</strong>, because everyone should have the chance to learn the magic of programming."
    ...
    team_values: "Valorizamos diálogos abertos e respeitosos, onde a melhor ideia vence. Nossas decisões são baseadas em pesquisa de clientes e nosso proceso é focado em entregar resultados tangíveis a eles. Todos estão envolvidos, desde nosso CEO à nossos contribuidores no GitHub, porque valorizamos o crescimento e aprendizado em nossa equipe."
...
#    robin_blurb: "Scaffolding"
    ...
    phoenix_title: "Engenheiro de Software"
...
#    sean_title: "Territory Manager"
    ...
    community_subtitle: "Mais de 450 contribuidores ajudaram a construir CodeCombat, com cada vez mais juntando-se a nós cada semana!"
    community_description_3: "CodeCombat é um"
    community_description_link_2: "projeto comunitário"
    community_description_1: "no qual centenas de jogadores voluntariamente criam níveis, contribuem para nosso código e adicionam novos recursos, consertos de bugs, testam os níveis, e ainda traduzem o jogo em mais de 50 idiomas até agora. Empregados, contribuidores e o site ganham ao compartilharem ideias e unir esforços, como toda comunidade de código-livre em geral. Este site é construído com diversos projetos de código-livre, e estamos abertamente os devolvendo à comunidade e provendo aos jogadores interessados em códigos um projeto familiar para explorar e experimentar. Todos podem se juntar a comunidade do CodeCombat! Venha conferir nossa"
    community_description_link: "página de contribuidores"
...
#    downloads_title: "Download Assets & Information"
    ...
    character_art: "Arte dos personagens"
...
#    subtitle: "Get your students started in less than an hour. You'll be able to <strong>create a class, add students, and monitor their progress</strong> as they learn computer science."
    ...
    phone_number_help: "Onde podemos contactá-lo em días úteis?"
...
#    num_students_default: "Select Range"
    education_level_label: "Nívels de educação dos estudantes"
    education_level_help: "Escolha tantos quantos servirem."
    elementary_school: "Ensino Fundamental 1"
    high_school: "Ensino Médio"
    please_explain: "(por favor, explique)"
    middle_school: "Ensino fundamental 2"
    college_plus: "Nível Superior ou acima"
    anything_else: "Algo mais que deveríamos saber?"
...
#    not: "Not"
  ...
  courses:
    ...
    number_programming_students: "Número de estudantes de programação"
    number_total_students: "Número total de estudantes na escola"
...
#    designed_to: "Courses are designed to introduce computer science concepts using CodeCombat's fun and engaging environment. CodeCombat levels are organized around key topics to encourage progressive learning, over the course of 5 hours."
    ...
    no_experience: "Não é necessária experiência com códigos"
    easy_monitor: "Monitore facilmente o progresso de estudantes"
#    purchase_for_class: "Purchase a course for your entire class. It's easy to sign up your students!"
    see_the: "Veja o"
    more_info: "para mais informação."
    choose_course: "Escolha seu Curso:"
    enter_code: "Entre com um código de desbloqueio para juntar-se à uma turma existente"
    enter_code1: "Insira o código de desbloqueio"
    enroll: "Matricular-se"
    pick_from_classes: "Escolher de suas turmas atuais"
    enter: "Entrar"
    or: "Ou"
    topics: "Tópicos"
...
#    use_multiple: "Use licenses for the following students:"
    already_enrolled: "já matriculados"
...
#    change_language: "Change Course Language"
    ...
    greetings: "Saudações!"
    back_classrooms: "Voltar para as turmas"
...
#    tournament_blurb_ace_of_coders: "Battle it out in the frozen glacier in this domination-style mirror match! The tournament began on Wednesday, September 16 and will run until Wednesday, October 14 at 5PM PDT. Check out the details"
  ...
  account:
    ...
    email_sent: "Email enviado! Cheque sua caixa de entrada"
    verifying_email: "Verificando seu endereço de e-mail..."
    successfully_verified: "Seu e-mail foi verificado com sucesso!"
...
#    purchase_code3: "Subscription Code months will be added to the end of any existing subscription on the account."
    ...
    purchase_button: "Confirmar compra"
    your_codes: "Seus códigos"
#    redeem_codes: "Redeem a Subscription Code"
#    prepaid_code: "Prepaid Code"
#    lookup_code: "Lookup prepaid code"
    apply_account: "Aplicar em sua própria conta"
#    copy_link: "You can copy the code's link and send it to someone."
    quantity: "Quantidade"
#    redeemed: "Redeemed"
    no_codes: "Sem códigos ainda!"
    you_can1: "Você pode"
    you_can2: "comprar um código pré-pago"
    you_can3: "que pode ser aplicado em sua própria conta ou dado de presente para outros."

#  coppa_deny:
    text1: "Mal pode esperar para começar a programar?"
    text2: "Seus responsáveis precisarão criar uma conta para você usar! Mande um email para team@codecombat.com caso tenha alguma dúvida."
    close: "Fechar janela"
...
#    forbidden_desc: "Oh no, there’s nothing we can show you here! Make sure you’re logged into the correct account, or visit one of the links below to get back to programming!"
    ...
    not_found_desc: "Hmm, não há nada aqui. Visite um dos seguintes links para voltar para a programação!"
...
#    bootstrap: "Bootstrap"
  ...
  legal:
    ...
    cost_title: "Custo"
    cost_description: "CodeCombat é gratis para jogar em todos os seus níveis básicos, mas pagando ${{price}} USD/mês você tem acesso a níveis extras, novas categorias e {{gems}} gemas por mês. Para cancelar, basta um clique, e oferecemos a garantia de 100% do seu dinheiro de volta."
